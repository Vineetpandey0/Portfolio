...
export default async function Home() {
  ...
  const techStack = [
    "react", "nextjs", "typescript", "javascript", "tailwind", "html", "css", 
    "nodejs", "express", "c", "cpp", "python", "mongodb", "supabase", "git", "github", "zustand"
  ];
    ...
    <div className="max-w-[1200px] mx-auto px-8">
      ...
      <main>
        <section id="about" className="pt-14 flex flex-col items-center text-center">
          <div className="mb-8 w-40 h-40 rounded-full bg-gradient-to-br from-border to-bg relative flex items-center justify-center border-4 border-surface shadow-lg overflow-hidden opacity-0 animate-fade-in delay-100">
             <div className="text-text-secondary text-sm font-medium text-center p-4">
               Image Upload Later
             </div>
          </div>
          <h1 
        ...
        <section id="projects" className="py-20">
          <h2 
            className="text-4xl font-bold mb-12 relative inline-block after:content-[''] after:absolute after:-bottom-2.5 after:left-0 after:w-12 after:h-1 after:bg-accent after:rounded-sm animate-fade-in" 
            style={{ fontFamily: "var(--font-outfit)" }}
          >
            Selected Projects
          </h2>
            ...
            {repos.map((repo, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-2xl font-bold text-text-primary" style={{ fontFamily: "var(--font-outfit)" }}>{repo.name}</h3>
                  <svg 
