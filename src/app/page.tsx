...
export default async function Home() {
  ...
  const activeProjects = ["spawnapps", "adstudio", "readyui", "context-sync", "sparkl"];
  const projectsToDisplay = ["spawnapps", "adstudio", "readyui", "context-sync", "sparkl"]; // Only these projects will be shown
      ...
      <header className="py-8 flex justify-between items-center animate-fade-in">
        ...
        <nav className="flex items-center gap-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full font-semibold text-sm border border-accent text-accent hover:bg-accent hover:text-white transition-all duration-200 hover:-translate-y-0.5"
          >
